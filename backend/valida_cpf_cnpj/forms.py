...
from valida_cpf_cnpj.validators import validate_cpf, validate_cnpj
from valida_cpf_cnpj.widgets import CPFWidget, CNPJWidget
from valida_cpf_cnpj.cpf import cpf_to_python
from valida_cpf_cnpj.cnpj import cnpj_to_python
