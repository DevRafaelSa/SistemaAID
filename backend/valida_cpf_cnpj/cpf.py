...
from valida_cpf_cnpj.validators import is_valid_cpf, cpf_random_generator
import re
...
class CPF(object):
    ...
    def __lt__(self, other):
        ...
        if invalid is not None:
            raise ValueError('CPF inválido: %r' % invalid)
...
def cpf_to_python(value):
    if value in [None, '']:
        ...
        raise TypeError("Não é possível converter %s para CPF." % type(value).__name__)
